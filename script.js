...
(() => {
  ...
  function speakFr(text) {
    ...
    u.lang = "fr-FR";
    u.voice = voices.find(v => /^fr[-_]?FR/i.test(v.lang)) || voices.find(v => /^fr/i.test(v.lang)) || null;
    u.rate = 0.92;
    u.pitch = 1;
